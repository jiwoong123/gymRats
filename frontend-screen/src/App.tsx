...
import AccountManagement from "./pages/menu/AccountManagement";
import Root from "./pages/root";
import Diet from "./pages/diet/Diet";
import Body from "./pages/diet/Body"
...
import RoutineManagement from "./pages/routine/RoutineManagement";
import Statistics from "./pages/records/Statistics";
...
function App() {
    ...
    <Routes>
      ...
      >
        ...
        <Route path="/menu/account" element={<AccountManagement />} />
        ...
        <Route path="/routine/:routineId/edit" element={<NewRoutine />} />
