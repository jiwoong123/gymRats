...
const RECENT_WORKOUTS = [
  ...
  { date: "2일 전", name: "등 · 이두", duration: 72, volume: 6800 },
  { date: "4일 전", name: "하체", duration: 65, volume: 9200 },
];

const QUICK_WORKOUTS = [
  { label: "가슴 · 삼두", emoji: "💪", color: "#ff6b35" },
  { label: "등 · 이두", emoji: "🏋️", color: "#00e5ff" },
  { label: "하체", emoji: "🦵", color: "#a855f7" },
  { label: "어깨", emoji: "🔥", color: "#c8ff00" },
];
